...
# --- 1. Konfigurasi Database (Sama seperti MS1, menggunakan DB-A) ---
...
def root():
    return {"message": "MS2 Server (FastAPI) is Ready"}
...
if __name__ == '__main__':
    create_tables()
    # PERBEDAAN: Jalankan di port 5052 dan panggil file ms2
    uvicorn.run("ms2:app", host="0.0.0.0", port=5052, reload=True)
